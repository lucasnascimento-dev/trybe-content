...
if (salario_bruto <= 1556.94) {
    ...
    console.log("Seu salário base é de R$"+salario_base+",00 Foi dencontado RS"+desconto+",00 do INSS" )
}
...
if (salario_base <= 1903.98) {
    ...
    console.log("Seu salário líquido é de R$"+salario_liquido+",00 Faixa Isenta de imposto de renda.")
}
else if (salario_base <= 2826.65) {
    parcela_a_deduzir = 142.80;
    desconto = (aliquota_ir_7*salario_base)-parcela_a_deduzir;
    salario_liquido = salario_base-desconto;
    console.log("Seu salário líquido é de R$"+salario_liquido+",00 Foi descontado R$ "+desconto+",00 de imposto de renda")
}
