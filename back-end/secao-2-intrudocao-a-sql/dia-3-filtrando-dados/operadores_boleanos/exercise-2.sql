...
/*
EXERCISE 4
Mostre os dois casos em que, a partir do 4° caractere no título do
filme, tem-se a palavra gon.
*/
SELECT * FROM sakila.film
...
/*
EXERCISE 7
Mostre os seis filmes que contêm as palavras monkey e sumo em suas
descrições.
*/
SELECT * FROM sakila.film
